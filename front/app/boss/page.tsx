    ...
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            {checkingLogin ? (
              <Button size="sm" disabled className="rounded-xl bg-muted text-muted-foreground cursor-not-allowed px-4">
              ...
              <Button onClick={handleStopDelivery} size="sm" className="rounded-xl bg-destructive hover:bg-destructive/90 text-white px-4 shadow-bento-sm hover:shadow-bento transition-all duration-200">
                <BiStop className="mr-1" /> 停止投递
              </Button>
            ) : (
              <Button onClick={handleStartDelivery} size="sm" className="rounded-xl bg-green-600 hover:bg-green-700 text-white px-4 shadow-bento-sm hover:shadow-bento transition-all duration-200">
                <BiPlay className="mr-1" /> 开始投递
              </Button>
            )}
            <Button onClick={() => setShowLogoutDialog(true)} size="sm" className="rounded-xl bg-destructive hover:bg-destructive/90 text-white px-4 shadow-bento-sm hover:shadow-bento transition-all duration-200">
              <BiLogOut className="mr-1" /> 退出登录
            </Button>
            <Button onClick={() => handleSave(false)} size="sm" className="rounded-xl bg-primary hover:bg-primary/90 text-white px-4 shadow-bento-sm hover:shadow-bento transition-all duration-200">
      ...
      <Tabs defaultValue="config" className="w-full">
        ...
        <TabsContent value="config" className="mt-6">
          ...
          {/* 平台说明 */}
          <Card className="col-span-full animate-in fade-in slide-in-from-bottom-5 duration-700">
            <CardHeader>
          ...
          {/* 薪资和经验 */}
          <Card className="md:col-span-2 lg:col-span-2 animate-in fade-in slide-in-from-bottom-6 duration-700">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
        ...
        {/* 公司要求 */}
        <Card className="col-span-full animate-in fade-in slide-in-from-bottom-7 duration-700">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
        ...
        {/* 黑名单管理 */}
        <Card className="col-span-full animate-in fade-in slide-in-from-bottom-8 duration-700">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <BiSearch className="text-primary" />
      ...
      {showLogoutDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-card rounded-2xl shadow-2xl w-[92%] max-w-sm border border-border animate-in fade-in zoom-in-95">
              ...
              <CardContent className="pt-0">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Button
                    ...
                    className="rounded-xl bg-destructive hover:bg-destructive/90 text-white px-4"
                  >
                    确认退出
                  </Button>
                </div>
              ...
              <CardContent className="pt-0">
                ...
                <div className="flex justify-end gap-2">
                  <Button
                    ...
                    className={`rounded-xl px-4 ${logoutResult.success ? 'bg-green-600 hover:bg-green-700 text-white' : 'bg-destructive hover:bg-destructive/90 text-white'}`}
                  >
                    知道了
                  </Button>
                </div>
              ...
              <CardContent className="pt-0">
                ...
                <div className="flex justify-end gap-2">
                  <Button
                    ...
                    className={`rounded-xl px-4 ${saveResult.success ? 'bg-green-600 hover:bg-green-700 text-white' : 'bg-destructive hover:bg-destructive/90 text-white'}`}
                  >
                    知道了
                  </Button>
                </div>
  ...
  return (
    <div className="relative" ref={wrapperRef}>
      <button
        ...
        className="flex h-10 w-full items-center justify-between rounded-xl border border-border bg-background px-4 py-2 text-sm transition-all duration-200 hover:border-border/80 hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:ring-offset-0"
      >
          ...
          <div className="flex flex-col gap-2">
            {options.map((opt) => {
              ...
              return (
                <div
                  key={opt.id}
                  className={`group inline-flex items-center justify-between gap-3 rounded-xl px-3 py-2 cursor-pointer transition-all border ${checked ? 'border-primary/40 bg-primary/10 text-foreground shadow-bento-sm' : 'border-border bg-background text-foreground hover:bg-accent'}`}
                  onClick={(e) => {
                ...
                >
                  <span className="flex items-center gap-3">
                    <span className={`inline-flex h-4 w-4 items-center justify-center rounded-md border border-border bg-background transition-all ${checked ? 'bg-primary border-primary' : ''}`}></span>
