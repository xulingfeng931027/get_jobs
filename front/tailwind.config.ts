...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        // Bento Grid 阴影系统
        'bento-sm': '0 1px 2px rgba(0,0,0,0.04), 0 1px 3px rgba(0,0,0,0.06)',
        'bento': '0 2px 8px rgba(0,0,0,0.04), 0 4px 16px rgba(0,0,0,0.06)',
        'bento-lg': '0 4px 12px rgba(0,0,0,0.05), 0 8px 32px rgba(0,0,0,0.08)',
        // Solid Next.js 阴影
